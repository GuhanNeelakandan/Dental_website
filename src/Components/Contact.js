...
function Contact() {
  let formik = useFormik({
    ...
    onSubmit: async (values) => {
      try {
        await axios.post(
          "https://neosmile-crud.herokuapp.com/bookAppointment",
          values
        );
      ...
      <div className="container-fluid">
          ...
          <div className="col-sm-12 col-md-12 col-lg-6 col-xl-6 col-xxl-6">
            <Animated>
              <div className="head-service">
                <img classname="service-image" src={contact} />
                <h1 className="service-heading">Contact</h1>
              </div>
            </Animated>
          </div>
        </div>
        ...
        <div className="row contact-card">
          <div className="col-sm-12 col-md-4 col-lg-4 col-xl-4 col-xxl-4 contact-enquiry">
            <h5 className="contact-topics">
              For enquiry &amp; appointment Bookings
            </h5>
            <p className="us">Whatsapp us:</p>
            <a
              className="btn link"
              href="https://wa.me/7708282837"
              target="_blank"
            >
              7708282837
            </a>
          ...
          <div className="col-sm-12 col-md-4 col-lg-4 col-xl-4 col-xxl-4">
            ...
            <p className="us">
              <a
                id="locate-contact"
                href="https://www.google.com/maps/place/NEOSMILE+DENTAL+AND+IMPLANT+CENTRE/@12.8875614,80.2285973,15z/data=!4m12!1m6!3m5!1s0x0:0x90a145a0ad547d96!2sNEOSMILE+DENTAL+AND+IMPLANT+CENTRE!8m2!3d12.8875614!4d80.2285973!3m4!1s0x0:0x90a145a0ad547d96!8m2!3d12.8875614!4d80.2285973"
                target="_blank"
              >
                No.30 Annai Indira Gandhi Street, Shollinganallur
              </a>
            </p>
